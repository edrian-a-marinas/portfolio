...
// derives a display label from a filename, e.g. "roadmap.pdf" -> "Roadmap"
    ...
    <div className="project-card desktop-reveal">
      ...
      <div className="project-actions" onClick={e => e.stopPropagation()}>
        ...
        {p.docs && p.docs.map(doc => (
          <a key={doc.href} className="project-doc" href={doc.href} target="_blank" rel="noopener noreferrer">
            <IconDoc /> {doc.label}
          </a>
        ))}
      </div>
